...
public class CategoryResourceTest {
    ...
    public void initTest() {
        ...
        category.setTimeToWait(DEFAULT_TIME_TO_WAIT);
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getTimeToWait()).isEqualTo(DEFAULT_TIME_TO_WAIT);
    }
    ...
    public void getAllCategorys() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categorys"))
                ...
                .andExpect(jsonPath("$.[*].timeToWait").value(hasItem(DEFAULT_TIME_TO_WAIT)));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categorys/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.timeToWait").value(DEFAULT_TIME_TO_WAIT));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        category.setColor(UPDATED_COLOR);
        category.setTimeToWait(UPDATED_TIME_TO_WAIT);
